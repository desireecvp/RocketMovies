import { Main, TitleContainer, Subtitle, MiddleContent, TagsWrapper } from "./styles";
  ...
  return (
    <div>
      <Main>
        ...
        <Subtitle>
          <img src="https://github.com/desireecvp.png" alt="Imagem usuario" />
          <p>Por Desiree Possiedi</p>
          <CiClock2 />
          <p id="date">23/05/22 às 08:00</p>
        </Subtitle>

        <MiddleContent>

          <TagsWrapper>
          <ButtonTag title="Ficção Científica"/>
          <ButtonTag title="Drama"/>
          <ButtonTag title="Família"/>
          </TagsWrapper>
